...
class Ball:
    ...
    def check_collide(self,left_paddle,right_paddle):
        ...
        left_puddle_left = left_paddle.x
        ...
        right_puddle_left = right_paddle.x
        ...
        if self.speedx < 0:
            ...
            if left_paddle_top < ball_left_y and left_paddle_bottom > ball_left_y and left_puddle_left < ball_left_x and left_paddle_right > ball_left_x:
                self.speedx *= -1
            ...
            if right_paddle_top < ball_right_y and right_paddle_bottom > ball_right_y and right_puddle_left < ball_right_x and right_paddle_right > ball_right_x:
                self.speedx *= -1
                self.speedy += random.randint(-5,5)
